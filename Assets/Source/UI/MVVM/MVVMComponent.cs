...
{
    public class MVVMComponent<TState, TView, TViewModel, TModel> where TView : View<TState, TViewModel> where TModel : Model<TState, TViewModel> where TViewModel : ViewModel<TState>, new()
    {
        private TView _view;
